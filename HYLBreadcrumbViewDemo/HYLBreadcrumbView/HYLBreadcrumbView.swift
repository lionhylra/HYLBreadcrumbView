...
@objc public protocol HYLBreadcrumbViewDelegate:NSObjectProtocol {
...
@objc public protocol HYLBreadcrumbViewDataSource:NSObjectProtocol {
...
public class HYLBreadcrumbView: UIView {
    ...
    @IBOutlet public var delegate:HYLBreadcrumbViewDelegate?
    @IBOutlet public var dataSource: HYLBreadcrumbViewDataSource?
    ...
    private var separatorWidth:CGFloat {
        return delegate?.widthForSeparatorViewInBreadcrumbView?(self) ?? defaultSeparatorWidth
    }
